...
import (
  "github.com/JosMPena/first_go_webapp/daemon"
)
...
func processFlags() *daemon.Config {
  ...
  flag.StringVar(&cfg.Db.ConnectString, "db-connect", "host=/var/run/postgresql dbname=fowebapp sslmode=disable", "DB Connect String")
